...
class InMemoryInventory:
    def __init__(self):
        self.reservations=set(); self.reserve_calls=[]; self.release_calls=[]
    def reserve(self,o,s):
        self.reserve_calls.append((o,s)); self.reservations.add((o,s))
    def release(self,o,s):
        self.release_calls.append((o,s)); self.reservations.discard((o,s))
